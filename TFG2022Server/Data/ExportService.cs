...
namespace TFG2022Server.Data
{
    public class ExportService
    {
        ...
        public static MemoryStream CreatePdfVentaFisica(Pedido pedido, Usuario user, List<ProductoModel> productos, List<LineaPedidoModel> lineas, double costePedido)
        {
            if (pedido == null)
            {
                throw new ArgumentNullException("Pedido cannot be null");
            ...
            using (PdfDocument pdfDocument = new PdfDocument())
            {
                ...
                pdfGridPedido = addPedidoToGridNoGastosDeEnvio(pdfGridPedido, pedido, costePedido);
                pdfGridPedido.Style.Font = contentFont;
                ...
                pdfGridLineasProductos.Style.CellPadding.Right = cellMargin;
                pdfGridLineasProductos.ApplyBuiltinStyle(PdfGridBuiltinStyle.GridTable4Accent1);
                pdfGridLineasProductos = addLineasToGridVentaFisica(pdfGridLineasProductos, user, productos, lineas);
                pdfGridLineasProductos.Style.Font = contentFont;
        ...
        private static PdfGrid addPedidoToGridNoGastosDeEnvio(PdfGrid pdfGrid, Pedido pedido, double costePedido)
        {
            //Add three columns.
            pdfGrid.Columns.Add(2);
