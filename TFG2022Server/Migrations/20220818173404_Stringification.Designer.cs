...
namespace TFG2022Server.Migrations
{
    ...
    [Migration("20220818173404_Stringification")]
    partial class Stringification
    {
            ...
            modelBuilder.Entity("TFG2022Server.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaNacimiento = new DateTime(2022, 8, 18, 19, 34, 3, 619, DateTimeKind.Local).AddTicks(9649),
                            Nombre = "Alberto",
                            Rol = "cliente",
                            Telefono = "123123123"
                        },
